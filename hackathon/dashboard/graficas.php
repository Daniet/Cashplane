...
while($row = mysqli_fetch_array($result)){
    $rotulos = $row['ROTULOS'];
    $value = $row['COUNT(`Cod Cajero`)'];
    echo "<rotulos key=\"$rotulos\" value=\"$value\"></rotulos>";
}
echo '</data>';
...
var color = d3.scale.ordinal()
	.domain([<? echo $rotulos2;  ?>])
	.range(["#98abc5", "#8a89a6", "#7b6888", "#6b486b", "#a05d56", "#d0743c", "#ff8c00"]);

let values = {
  'CAJEROS SIN DINERO Y POSIBLEMENTE FUERA DE LINEA': 40,
  'CAJERO ENTRE 16% Y 50% DE ABASTECIMIENTO': 50,
}
console.log(values)
function randomData (){
